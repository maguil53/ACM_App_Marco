...
public class AboutRecyclerAdapter extends RecyclerView.Adapter<AboutRecyclerAdapter.AboutViewHolder> {
    ...
    public AboutRecyclerAdapter(List<ACMLeader> leaders, Context context) {
    ...
    @NonNull
    @Override
    public AboutRecyclerAdapter.AboutViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.acm_leader_card,viewGroup,false);


        return new AboutRecyclerAdapter.AboutViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AboutRecyclerAdapter.AboutViewHolder recyclerViewHolder, int i) {
